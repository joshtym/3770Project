...
void ProcessorWindow::loadSpecs()
{
   ...
   specLayouts[0]->addWidget(new QLabel("AMD FX-8350 Black Edition Vishera 8-core 4.0 GHz"));
   specLayouts[0]->addWidget(new QLabel("Model"));
   specLayouts[0]->addWidget(new QLabel("Brand: AMD"));
   specLayouts[0]->addWidget(new QLabel("Series: FX-Series"));
   specLayouts[0]->addWidget(new QLabel("Name: FX-8350 Black Edition"));
   specLayouts[0]->addWidget(new QLabel("CPU Socket Type: Socket AM3+"));
   specLayouts[0]->addWidget(new QLabel("Details"));
   specLayouts[0]->addWidget(new QLabel("Core Name: Vishera"));
   specLayouts[0]->addWidget(new QLabel("Number of Cores: 8-Core"));
   specLayouts[0]->addWidget(new QLabel("Number of Threads: 8"));
   specLayouts[0]->addWidget(new QLabel("Operating Frequency: 4.0 GHz (4.2Ghz Turbo"));
   specLayouts[0]->addWidget(new QLabel("L2 Cache: 4 x 2MB"));
   specLayouts[0]->addWidget(new QLabel("L3 Cache: 8MB"));
   specLayouts[0]->addWidget(new QLabel("Manufacturing Tech: 32nm"));
   specLayouts[0]->addWidget(new QLabel("64-Bit Support: Yes"));
   specLayouts[0]->addWidget(new QLabel("Thermal Design Power: 125W"));
   
   specLayouts[1]->addWidget(new QLabel("AMD FX-6300 Vishera 6-Core 3.5 GHz"));
   specLayouts[1]->addWidget(new QLabel("Model"));
   specLayouts[1]->addWidget(new QLabel("Brand: AMD"));
   specLayouts[1]->addWidget(new QLabel("Series: FX-Series"));
   specLayouts[1]->addWidget(new QLabel("Name: FX-6300"));
   specLayouts[1]->addWidget(new QLabel("CPU Socket Type: Socket AM3+"));
   specLayouts[1]->addWidget(new QLabel("Details"));
   specLayouts[1]->addWidget(new QLabel("Core Name: Vishera"));
   specLayouts[1]->addWidget(new QLabel("Number of Cores: 6-Core"));
   specLayouts[1]->addWidget(new QLabel("Number of Threads: 6"));
   specLayouts[1]->addWidget(new QLabel("Operating Frequency: 3.5 GHz (4.1Ghz Turbo"));
   specLayouts[1]->addWidget(new QLabel("L3 Cache: 8MB"));
   specLayouts[1]->addWidget(new QLabel("Manufacturing Tech: 32nm"));
   specLayouts[1]->addWidget(new QLabel("64-Bit Support: Yes"));
   specLayouts[1]->addWidget(new QLabel("Thermal Design Power: 95W"));
   
   specLayouts[2]->addWidget(new QLabel("AMD Athlon X4 860k"));
   specLayouts[2]->addWidget(new QLabel("Model"));
   specLayouts[2]->addWidget(new QLabel("Brand: AMD"));
   specLayouts[2]->addWidget(new QLabel("Series: Athlon X4"));
   specLayouts[2]->addWidget(new QLabel("Name: Athlon X4 860k"));
   specLayouts[2]->addWidget(new QLabel("CPU Socket Type: Socket FM2+"));
   specLayouts[2]->addWidget(new QLabel("Details"));
   specLayouts[2]->addWidget(new QLabel("Core Name: Kaveri"));
   specLayouts[2]->addWidget(new QLabel("Number of Cores: Quad-Core"));
   specLayouts[2]->addWidget(new QLabel("Number of Threads: 4"));
   specLayouts[2]->addWidget(new QLabel("Operating Frequency: 3.7 GHz"));
   specLayouts[2]->addWidget(new QLabel("Max Turbo Frequency: 4.0 GHz"));
   specLayouts[2]->addWidget(new QLabel("L2 Cache: 2 x 2MB"));
   specLayouts[2]->addWidget(new QLabel("Manufacturing Tech: 28nm"));
   specLayouts[2]->addWidget(new QLabel("64-Bit Support: Yes"));
   specLayouts[2]->addWidget(new QLabel("Integrated Memory Controller Speed: 2133 MHz"));
   specLayouts[2]->addWidget(new QLabel("Thermal Design Power: 95W"));
   
   specLayouts[3]->addWidget(new QLabel("Intel Core i7-4790K Devil's Canyon Quad-Core"));
   specLayouts[3]->addWidget(new QLabel("Model"));
   specLayouts[3]->addWidget(new QLabel("Brand: Intel"));
   specLayouts[3]->addWidget(new QLabel("Series: Core i7"));
   specLayouts[3]->addWidget(new QLabel("Name: Core i7-4790K"));
   specLayouts[3]->addWidget(new QLabel("CPU Socket Type: LGA 1150"));
   specLayouts[3]->addWidget(new QLabel("Details"));
   specLayouts[3]->addWidget(new QLabel("Core Name: Devil's Canyon"));
   specLayouts[3]->addWidget(new QLabel("Number of Cores: Quad-Core"));
   specLayouts[3]->addWidget(new QLabel("Number of Threads: 8"));
   specLayouts[3]->addWidget(new QLabel("Operating Frequency: 4.0 GHz"));
   specLayouts[3]->addWidget(new QLabel("Max Turbo Frequency: 4.4 GHz"));
   specLayouts[3]->addWidget(new QLabel("L2 Cache: 4 x 256KB"));
   specLayouts[3]->addWidget(new QLabel("L3 Cache: 8MB"));
   specLayouts[3]->addWidget(new QLabel("Manufacturing Tech: 22nm"));
   specLayouts[3]->addWidget(new QLabel("64-Bit Support: Yes"));
   specLayouts[4]->addWidget(new QLabel("Hyper-Threading Support: No"));
   specLayouts[3]->addWidget(new QLabel("Integrated Graphics: Intel HD Graphics 4600"));
   specLayouts[3]->addWidget(new QLabel("Graphics Base Frequency: 350 MHz"));
   specLayouts[3]->addWidget(new QLabel("Graphics Max Dynamic Frequency: 1.25 GHz"));
   
   specLayouts[4]->addWidget(new QLabel("Intel Core i5-4690K Devil's Canyon Quad-Core"));
   specLayouts[4]->addWidget(new QLabel("Model"));
   specLayouts[4]->addWidget(new QLabel("Brand: Intel"));
   specLayouts[4]->addWidget(new QLabel("Series: Core i5"));
   specLayouts[4]->addWidget(new QLabel("Name: Core i5-4690K"));
   specLayouts[4]->addWidget(new QLabel("CPU Socket Type: LGA 1150"));
   specLayouts[4]->addWidget(new QLabel("Details"));
   specLayouts[4]->addWidget(new QLabel("Core Name: Devil's Canyon"));
   specLayouts[4]->addWidget(new QLabel("Number of Cores: Quad-Core"));
   specLayouts[4]->addWidget(new QLabel("Number of Threads: 4"));
   specLayouts[4]->addWidget(new QLabel("Operating Frequency: 3.5 GHz"));
   specLayouts[4]->addWidget(new QLabel("Max Turbo Frequency: 3.9 GHz"));
   specLayouts[4]->addWidget(new QLabel("L2 Cache: 4 x 256KB"));
   specLayouts[4]->addWidget(new QLabel("L3 Cache: 6MB"));
   specLayouts[4]->addWidget(new QLabel("Manufacturing Tech: 22nm"));
   specLayouts[4]->addWidget(new QLabel("64-Bit Support: Yes"));
   specLayouts[4]->addWidget(new QLabel("Hyper-Threading Support: No"));
   specLayouts[4]->addWidget(new QLabel("Integrated Graphics: Intel HD Graphics 4600"));
   specLayouts[4]->addWidget(new QLabel("Graphics Base Frequency: 350 MHz"));
   specLayouts[4]->addWidget(new QLabel("Graphics Max Dynamic Frequency: 1.2 GHz"));
   specLayouts[4]->addWidget(new QLabel("Thermal Design Power: 88W"));
   
   specLayouts[5]->addWidget(new QLabel("Intel Core i3-6100 3M 3.7 GHz"));
   specLayouts[5]->addWidget(new QLabel("Model"));
   specLayouts[5]->addWidget(new QLabel("Brand: Intel"));
   specLayouts[5]->addWidget(new QLabel("Series: Core i3"));
   specLayouts[5]->addWidget(new QLabel("Name: Core i3-6100"));
   specLayouts[5]->addWidget(new QLabel("CPU Socket Type: LGA 1151"));
   specLayouts[5]->addWidget(new QLabel("Details"));
   specLayouts[5]->addWidget(new QLabel("Core Name: Skylake"));
   specLayouts[5]->addWidget(new QLabel("Number of Cores: Dual-Core"));
   specLayouts[5]->addWidget(new QLabel("Number of Threads: 4"));
   specLayouts[5]->addWidget(new QLabel("Operating Frequency: 3.7 GHz"));
   specLayouts[5]->addWidget(new QLabel("L2 Cache: 2 x 256KB"));
   specLayouts[5]->addWidget(new QLabel("L3 Cache: 3MB"));
   specLayouts[5]->addWidget(new QLabel("Manufacturing Tech: 14nm"));
   specLayouts[5]->addWidget(new QLabel("64-Bit Support: Yes"));
   specLayouts[5]->addWidget(new QLabel("Hyper-Threading Support: Yes"));
   specLayouts[5]->addWidget(new QLabel("Integrated Graphics: Intel HD Graphics 530"));
   specLayouts[5]->addWidget(new QLabel("Graphics Max Dynamic Frequency: 1.05 GHz"));
   specLayouts[5]->addWidget(new QLabel("Thermal Design Power: 65W"));
}
